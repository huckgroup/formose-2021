...
series_x1_values = [x_factor*exp_info[x].parameters[condition_sel_1]
                        for x in series_dict[series_sel]]
series_x2_values = [x_factor*exp_info[x].parameters[condition_sel_2]
                        for x in series_dict[series_sel]]

series_x_values = np.array([x/y for x,y in zip(series_x1_values,series_x2_values)])
i = np.argsort(series_x_values)
